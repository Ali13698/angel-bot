...
// v3 - accepts BOTH cf_token and cftoken

const CF_TOKEN = process.env.cftoken || process.env.cf_token;
const CF_ACCOUNT = process.env.cfaccount || process.env.cf_account;
const CF_DB = process.env.cfdb || process.env.cf_db;

console.log("[d1] v3 loading");
...
if (!CF_TOKEN || !CF_ACCOUNT || !CF_DB) {
  console.error("[d1] Missing env vars v3");
  process.exit(1);
}
...
export async function initTables() {
  ...
  `);
  console.log("[d1] tables ready v3");
}
