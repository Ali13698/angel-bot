...
export const BALE_TOKEN = process.env.baletoken || process.env.bale_token;
...
const ADJ = ['آبی','طلایی','نقره‌ای','بنفش','سبز','سرخ','سفید','کهربا','فیروزه','یاقوتی'];
const NOUN = ['عقاب','شیر','پلنگ','گرگ','سیمرغ','اژدها','ققنوس','شاهین','یوز','کرگدن'];
...
if (!CF_TOKEN || !CF_ACCOUNT || !CF_DB) { console.error('[config] CF env missing'); process.exit(1); }
