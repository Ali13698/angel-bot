...
export async function initTables() {
  await query(`CREATE TABLE IF NOT EXISTS users (
    ...
    avatar TEXT, display_name TEXT, game_username TEXT, game_username_locked INTEGER DEFAULT 0,
    profile_color TEXT DEFAULT '#8b5cf6', profile_banner TEXT DEFAULT 'default', name_effect TEXT,
    referral_code TEXT, referred_by INTEGER, referrals_count INTEGER DEFAULT 0, referral_rewarded INTEGER DEFAULT 0,
    coins INTEGER DEFAULT 0, wins INTEGER DEFAULT 0, losses INTEGER DEFAULT 0,
    level INTEGER DEFAULT 1, xp INTEGER DEFAULT 0,
    streak_days INTEGER DEFAULT 0, last_active_date TEXT, likes_count INTEGER DEFAULT 0,
    active_days INTEGER DEFAULT 0, banned_until INTEGER DEFAULT 0,
  ...
  for (const a of userAlters) { try { await query(a); } catch(e) {} }
