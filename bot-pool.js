...
const FEMALE_NAMES = new Set([
  'سارا','نیلوفر','رها','آیدا','یاسمین','دنیا','هستی','غزل','ترمه','پانیذ',
  'نازنین','مریم','نرگس','لیلا','شیوا','الناز','پریسا','سمیرا','فاطمه','مینا',
  'زهرا','نسترن','شبنم','بهاره','هدیه','رضوان','مرجان','شادی','گلنار','کیانا',
  'ثنا','رویا','یکتا','بیتا','ترانه','نیکا','پگاه','ملیکا','روژان','تارا',
  'پرنیان','دیانا','مهسا','سوگند','آتنا','یلدا','ژاله','ماندانا','شراره','رعنا',
  'هلیا','آوین'
]);
